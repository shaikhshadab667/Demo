...
class NowPlayingVC: UIViewController {
    ...
    func getData(){
        Service.shareInstance.getNowPlayingData { (movies, error) in
            if(error==nil){
...
//        let posterPath = dataArray[indexPath.row].poster_path
//        let imageUrl = "https://image.tmdb.org/t/p/w\(posterPath!)"
...
//
    ...
    func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        ...
        let nowDetailVC = self.storyboard?.instantiateViewController(identifier: "NowPlayingDetailVC") as! NowPlayingDetailVC
        
        nowDetailVC.dataString = imageUrl
        nowDetailVC.detailTitle = detailData.title
        nowDetailVC.detailSubtitle = detailData.overview
        
        self.navigationController?.pushViewController(nowDetailVC, animated: true)
    }
